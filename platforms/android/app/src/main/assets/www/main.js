...
var map = {
	"../assignedmembertab/assignedmembertab.module": [
		"./src/app/layout/assignedmembertab/assignedmembertab.module.ts",
		"assignedmembertab-assignedmembertab-module"
	],
	"../bottomtabmenus/bottomtabmenus.module": [
	...
	"./layout/bottomtabmenus/bottomtabmenus.module": [
		"./src/app/layout/bottomtabmenus/bottomtabmenus.module.ts",
		"common",
		"bottomtabmenus-bottomtabmenus-module"
	],
	"./layout/bottomtabmenus/tabdetails/firsttab/firsttab.module": [
		"./src/app/layout/bottomtabmenus/tabdetails/firsttab/firsttab.module.ts",
		"tabdetails-firsttab-firsttab-module"
	],
	"./layout/bottomtabmenus/tabdetails/secondtab/secondtab.module": [
		"./src/app/layout/bottomtabmenus/tabdetails/secondtab/secondtab.module.ts",
		"common"
	],
	"./layout/branchselection/branchselection.module": [
		"./src/app/layout/branchselection/branchselection.module.ts",
		"layout-branchselection-branchselection-module"
	],
	"./layout/exerciseselection/exerciseselection.module": [
		"./src/app/layout/exerciseselection/exerciseselection.module.ts",
		"layout-exerciseselection-exerciseselection-module"
	],
	"./layout/mainmenu/mainmenu.module": [
		"./src/app/layout/mainmenu/mainmenu.module.ts",
		"layout-mainmenu-mainmenu-module"
	],
	"./layout/member-machine-assignment/member-machine-assignment.module": [
		"./src/app/layout/member-machine-assignment/member-machine-assignment.module.ts",
		"layout-member-machine-assignment-member-machine-assignment-module"
	],
	...
	"./tabdetails/secondtab/secondtab.module": [
		"./src/app/layout/bottomtabmenus/tabdetails/secondtab/secondtab.module.ts",
		"common"
	]
};
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, menuCtrl
...
/* harmony import */ var _services_httprequestinterceptor_service__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./services/httprequestinterceptor.service */ "./src/app/services/httprequestinterceptor.service.ts");
/* harmony import */ var _services_globalconstant_service__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./services/globalconstant.service */ "./src/app/services/globalconstant.service.ts");
...
/* harmony import */ var _services_http_request_handler_service__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./services/http-request-handler.service */ "./src/app/services/http-request-handler.service.ts");
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            ...
            providers: [
                ...
                _services_globalconstant_service__WEBPACK_IMPORTED_MODULE_15__["GlobalconstantService"],
                ...
                { provide: _angular_router__WEBPACK_IMPORTED_MODULE_3__["RouteReuseStrategy"], useClass: _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicRouteStrategy"] },
                {
                    ...
                    useClass: _services_httprequestinterceptor_service__WEBPACK_IMPORTED_MODULE_14__["HttprequestinterceptorService"],
                    multi: true
                }
            ],
...
/* harmony import */ var _globalconstant_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./globalconstant.service */ "./src/app/services/globalconstant.service.ts");
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.sendOTP = function (formData) {
        var _this = this;
        var formValues = JSON.stringify({ formData: formData });
        return new Promise(function (resolve) {
            _this.http.post(_this.global.sendotp_URL, formValues).subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
            });
    ...
    AuthService.prototype.verifyOTP = function (mobileForm, otpForm) {
        var _this = this;
        var formValues = JSON.stringify({ mobileInfo: mobileForm, otpInfo: otpForm });
        return new Promise(function (resolve) {
            _this.http.post(_this.global.verifyotp_URL, formValues).subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
            });
    ...
    AuthService.prototype.setloginPin = function (mobileForm, otpForm, setpinForm) {
        var _this = this;
        var formValues = JSON.stringify({ mobileInfo: mobileForm, otpInfo: otpForm, pinInfo: setpinForm });
        return new Promise(function (resolve) {
            _this.http.post(_this.global.setloginpin_URL, formValues).subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
            });
    ...
    AuthService.prototype.verifyLogin = function (loginForm) {
        var _this = this;
    ...
    AuthService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _globalconstant_service__WEBPACK_IMPORTED_MODULE_3__["GlobalconstantService"]])
    ], AuthService);
    return AuthService;
}());
...
var DataShareService = /** @class */ (function () {
    function DataShareService() {
         ...
         * Declaration
         */
        this.branchSelection = { branchSelectionObj: "" };
        this.exerciseSelection = { excersiceSelectionObj: "" };
        this.selectedMember = { selectedMemberObj: "" };
    }
    /**
     * Branch selection Data Share
     * @param obj
     */
    DataShareService.prototype.setSelectedBranchDatas = function (obj) {
        this.branchSelection.branchSelectionObj = obj;
    };
    DataShareService.prototype.getSelectedBranchDatas = function () {
     ...
     * @param obj
     */
    DataShareService.prototype.setSelectedExerciseDatas = function (obj) {
        this.exerciseSelection.excersiceSelectionObj = obj;
    };
    DataShareService.prototype.getSelectedExerciseDatas = function () {
     ...
     * @param obj
     */
    DataShareService.prototype.setSelectedMemberDatas = function (obj) {
        this.selectedMember.selectedMemberObj = obj;
    };
    DataShareService.prototype.getSelectedMemberDatas = function () {
...
/***/ "./src/app/services/globalconstant.service.ts":
/*!****************************************************!*\
  !*** ./src/app/services/globalconstant.service.ts ***!
  \****************************************************/
...
var GlobalconstantService = /** @class */ (function () {
    function GlobalconstantService(storage) {
        ...
        this.APIURL = "https://mantrahealthzone.co.in/";
        this.APIKEY = "24ecdccb1258eaacfd441e012ac034392403c692";
        // URL INFO
        //public signin = this.APIURL+"login/getLogin" ;
        this.signin = this.APIURL + "mantratrainerAppService/verifyEmplMobile";
        this.sendotp_URL = this.APIURL + "mantratrainerAppService/sendOTP";
         ...
         * Master data Fetch
         */
        this.allbranchList_URL = this.APIURL + "mantratrainerAppService/getAllBranchList";
        this.exerciseList_URL = this.APIURL + "mantratrainerAppService/getExerciseList";
        this.exerciseByID_URL = this.APIURL + "mantratrainerAppService/getExerciseById";
        this.todaysmemberList_URL = this.APIURL + "mantratrainerAppService/getTodaysMemberList";
        this.todaysAssignedMemberList_URL = this.APIURL + "mantratrainerAppService/getTodaysAssignedMemberList";
        this.todaysnonAssignedMachineList_URL = this.APIURL + "mantratrainerAppService/getTodaysNonAssignedMachineList";
    ...
    GlobalconstantService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
...
/***/ "./src/app/services/http-request-handler.service.ts":
/*!**********************************************************!*\
  !*** ./src/app/services/http-request-handler.service.ts ***!
  \**********************************************************/
/*! exports provided: HttpRequestHandlerService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HttpRequestHandlerService", function() { return HttpRequestHandlerService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
/* harmony import */ var _angular_common_http__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/common/http */ "./node_modules/@angular/common/fesm5/http.js");
/* harmony import */ var _globalconstant_service__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./globalconstant.service */ "./src/app/services/globalconstant.service.ts");
...
var HttpRequestHandlerService = /** @class */ (function () {
    function HttpRequestHandlerService(http, global) {
        this.http = http;
        this.global = global;
    }
    HttpRequestHandlerService.prototype.getAllBranchList = function () {
        var _this = this;
        //let formValues = JSON.stringify({formData:formData});
        return new Promise(function (resolve) {
            _this.http.get(_this.global.allbranchList_URL).subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
            });
    ...
    HttpRequestHandlerService.prototype.getExerciseList = function () {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.get(_this.global.exerciseList_URL).subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
            });
    ...
    HttpRequestHandlerService.prototype.getTodaysMemberList = function (branch, page) {
        var _this = this;
        //let formValues = JSON.stringify({formData:formData});
        return new Promise(function (resolve) {
            _this.http.get(_this.global.todaysmemberList_URL + "?branch=" + branch + "&page=" + page).subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
            });
    ...
    HttpRequestHandlerService.prototype.getTodaysAssignedMemberList = function (branch, page) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.get(_this.global.todaysAssignedMemberList_URL + "?branch=" + branch + "&page=" + page).subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
            });
    ...
    HttpRequestHandlerService.prototype.getNonAssignedMachineList = function (branch, selectedexercise) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.get(_this.global.todaysnonAssignedMachineList_URL + "?branch=" + branch + "&exercise=" + selectedexercise).subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
            });
    ...
    HttpRequestHandlerService.prototype.getExerciseById = function (selectedexercise) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.get(_this.global.exerciseByID_URL + "?exercise=" + selectedexercise).subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
            });
    ...
    HttpRequestHandlerService.prototype.assignExerciseToMember = function (formObj, memberData) {
        var _this = this;
        var formValues = JSON.stringify({ formdata: formObj, memInfo: memberData });
        return new Promise(function (resolve) {
            _this.http.post(_this.global.assignexerciseToMember_URL, formValues).subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
            });
    ...
    HttpRequestHandlerService.prototype.getAssignedMemberDetailByID = function (assignedID) {
        var _this = this;
        return new Promise(function (resolve) {
            _this.http.get(_this.global.assignedMemberDetailByID_URL + "?aid=" + assignedID).subscribe(function (data) {
                resolve(data);
            }, function (err) {
                console.log(err);
            });
    ...
    HttpRequestHandlerService.prototype.stopExerciseProcess = function (formObj) {
        var _this = this;
    ...
    HttpRequestHandlerService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_common_http__WEBPACK_IMPORTED_MODULE_2__["HttpClient"], _globalconstant_service__WEBPACK_IMPORTED_MODULE_3__["GlobalconstantService"]])
    ], HttpRequestHandlerService);
    return HttpRequestHandlerService;
}());
...
/***/ "./src/app/services/httprequestinterceptor.service.ts":
/*!************************************************************!*\
  !*** ./src/app/services/httprequestinterceptor.service.ts ***!
  \************************************************************/
/*! exports provided: HttprequestinterceptorService */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HttprequestinterceptorService", function() { return HttprequestinterceptorService; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm5/core.js");
...
var HttprequestinterceptorService = /** @class */ (function () {
    function HttprequestinterceptorService(global, storage) {
        this.global = global;
        this.storage = storage;
        console.log('Hello TokeninterceptorService');
    }
    HttprequestinterceptorService.prototype.intercept = function (request, next) {
        return rxjs_Observable__WEBPACK_IMPORTED_MODULE_2__["Observable"].fromPromise(this.handleAccess(request, next));
    };
    HttprequestinterceptorService.prototype.handleAccess = function (request, next) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            var apikey, changedRequest, headerSettings, _i, _a, key, newHeader;
            var _this = this;
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        newHeader = new _angular_common_http__WEBPACK_IMPORTED_MODULE_4__["HttpHeaders"](headerSettings);
    ...
    HttprequestinterceptorService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_globalconstant_service__WEBPACK_IMPORTED_MODULE_3__["GlobalconstantService"], _ionic_storage__WEBPACK_IMPORTED_MODULE_6__["Storage"]])
    ], HttprequestinterceptorService);
    return HttprequestinterceptorService;
}());
...
module.exports = __webpack_require__(/*! D:\AppDevelopment\MantraApp\mantratrainer\src\main.ts */"./src/main.ts");
